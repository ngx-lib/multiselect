...
describe('MultiselectService', () => {
  ...
  it('should not return closest element', inject([NgxMultiselectService], (service: NgxMultiselectService) => {
    // arrange
    // act
  ...
  it('should be mirror the object', inject([NgxMultiselectService], (service: NgxMultiselectService) => {
    // arrange
  ...
  describe('optionsGrouping', () => {
    it('should group by pass group property', inject([NgxMultiselectService], (service: NgxMultiselectService) => {
      // arrange
      // act
  ...
  it('should find unique numbers', inject([NgxMultiselectService], (service: NgxMultiselectService) => {
    // arrange
    const plyrs = JSON.parse(JSON.stringify(players));
  ...
  it('should flatten virtual group options', inject([NgxMultiselectService], (service: NgxMultiselectService) => {
    // arrange
